...
$proco = $bdd->query("SELECT * FROM produits WHERE category = 9");
...
if (isset($_POST['addProduct']))
{
  ...
  {
	$ajout = $bdd->prepare("INSERT INTO panier(id_cli,num_pro) VALUES(?, ?)");
	$ajout->execute(array($_SESSION['user'], $_POST['num_pro']));
  }
}
?>
<!DOCTYPE html>
<html lang="fr">
<head>
	<title>Asus Graphic Cards</title>
	<meta charset="utf-8">
	...
	<header>
		...
		<?php
				...
				?>
				  ...
				  {
				  ?>
					<form method="POST" action="asuscg.php">
...
<!--
https://www.ldlc.com/fr-be/fiche/PB00345087.php
https://www.ldlc.com/fr-be/fiche/PB00384225.php
https://www.ldlc.com/fr-be/fiche/PB00285773.php
https://www.ldlc.com/fr-be/fiche/PB00276745.php
-->
<footer>
