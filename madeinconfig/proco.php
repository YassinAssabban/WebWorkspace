	...
	<header>
		...
		<nav>
    		...
    		<div class="brandproco">
    			<a href="iserie.php"><div class="brandintel"><img class="intel" src="logo/intel.png"></div></a>
			   <a href="amdserie.php"><div class="brandamd"><img class="amd" src="logo/amd.png"></div></a>
    		</div>
