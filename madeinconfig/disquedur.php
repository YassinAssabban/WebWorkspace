	...
	<header>
		...
		<nav>
			...
			<div class="brandproco">
    			<a href="seagate.php"><div class="brandseagate"><img src="logo/seagate.png"></div></a>
			   <a href="wd.php"><div class="brandwd"><img src="logo/wd.png"></div></a>
    		</div>
