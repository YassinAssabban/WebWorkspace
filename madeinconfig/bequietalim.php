...
<body>
   ...
   <div class="row">
						  ...
						  <div class="column">
						  	<img src="img/alim/bequiet550.png">
						    <div class="card">
						      <h3>be quiet! Straight Power 11 550W 80PLUS Platinum</h3>
						      <br>
						      <p>L'alimentation modulaire be quiet! Straight Power 11 Platinum offre un fonctionnement silencieux sans compromis au niveau de la qualité. Certifiée 80PLUS Platinum, elle offre un très haut rendement énergétique. Un choix idéal pour les configurations silencieuses et les configurations gaming. 
						      </p>
						      <h1 class="price">128€<sup class="cent">95</sup></h1><br>
						      <input type="button" class="btnbasket" name="#" value="        AJOUTER AU PANIER  ">						    </div>
						  </div>

						   <div class="column">
						   	<img src="img/alim/bequiet650.png">
						    <div class="card">
						      <h3>be quiet! Straight Power 11 650W 80PLUS Platinum</h3>
						      <br>
						      <p>L'alimentation modulaire be quiet! Straight Power 11 Platinum offre un fonctionnement silencieux sans compromis au niveau de la qualité. Certifiée 80PLUS Platinum, elle offre un très haut rendement énergétique. Un choix idéal pour les configurations silencieuses et les configurations gaming.</p>
						      <h1 class="price">149€<sup class="cent">95</sup></h1><br>
						      <input type="button" class="btnbasket" name="#" value="        AJOUTER AU PANIER  ">						    </div>
						  </div>
						  
						  <div class="column">
						   	<img src="img/alim/bequiet750.png">
						    <div class="card">
						      <h3>be quiet! Straight Power 11 750W 80PLUS Platinum</h3>
						      <br>
						      <p>L'alimentation modulaire be quiet! Straight Power 11 Platinum offre un fonctionnement silencieux sans compromis au niveau de la qualité. Certifiée 80PLUS Platinum, elle offre un très haut rendement énergétique. Un choix idéal pour les configurations silencieuses et les configurations gaming.</p>
						      <h1 class="price">161€<sup class="cent">95</sup></h1><br>
						      <input type="button" class="btnbasket" name="#" value="        AJOUTER AU PANIER  ">						    </div>
						  </div>

						  <div class="column">
						   	<img src="img/alim/bequiet850.png">
						    <div class="card">
						      <h3>be quiet! Straight Power 11 850W 80PLUS Platinum</h3>
						      <br>
						      <p>L'alimentation modulaire be quiet! Straight Power 11 Platinum offre un fonctionnement silencieux sans compromis au niveau de la qualité. Certifiée 80PLUS Platinum, elle offre un très haut rendement énergétique. Un choix idéal pour les configurations silencieuses et les configurations gaming.</p>
						      <h1 class="price">184€<sup class="cent">94</sup></h1><br>
						      <input type="button" class="btnbasket" name="#" value="        AJOUTER AU PANIER  ">						    </div>
						  </div>
...
https://www.ldlc.com/fr-be/fiche/PB00305679.php
https://www.ldlc.com/fr-be/fiche/PB00305682.php
https://www.ldlc.com/fr-be/fiche/PB00305684.php
https://www.ldlc.com/fr-be/fiche/PB00305685.php
