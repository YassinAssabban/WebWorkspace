...
<body>
	<header>
		...
		<nav>
    		...
    		<a href="corsairwater.php"><div class="brandcorsair"><img class="corsair" src="logo/corsair.png"></div></a>
			 <a href="nzxt.php"><div class="brandnzxt"><img class="nzxt" src="logo/nzxt.png"></div></a>
    		</div>
<!--
